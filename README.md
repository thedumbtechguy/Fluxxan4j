...
##Introduction
 ...
 I will instead focus on showing you how to achieve Flux using Fluxxan4j. In this introduction tutorial, I will walk you through building the sample Todo app included in the source.
...
> Unlike Redux, Fluxxan4j does not force you to use an immutable state even though the default implementation assumes you do.
